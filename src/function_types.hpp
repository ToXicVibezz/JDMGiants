...
namespace big::functions
{
	...
	//// ADDED GARBAGE MONEY SHIT
	//using construct_basket_t = bool (*)(rage::CNetworkShoppingMgr* netshop_mgr, std::int32_t* id, std::uint32_t category, std::uint32_t action, std::uint32_t flags);
	//using add_item_to_basket_t = bool (*)(rage::CNetworkShoppingMgr* netshop_mgr, std::int32_t* items);
	//using begin_service_t = bool (*)(rage::CNetworkShoppingMgr* netshop_mgr, std::int32_t* id, std::uint32_t service_type, std::uint32_t category, std::uint32_t item, std::uint32_t action, std::int32_t value, std::uint32_t flags);
}
